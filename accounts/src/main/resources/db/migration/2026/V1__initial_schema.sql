...
-- Drives transactions.id (@SequenceGenerator allocationSize = 1)
...
-- -------------------------------------
-- Table: transactions
-- Entity: za.co.capitec.accounts.entity.Transactions
...
ALTER SEQUENCE account_transactions_sequence OWNED BY transactions.id;
